...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InstanceInputItem', function() {
      beforeEach(function() {
        instance = new Otpixel.InstanceInputItem();
      });

      it('should create an instance of InstanceInputItem', function() {
        // TODO: update the code to test InstanceInputItem
        expect(instance).to.be.a(Otpixel.InstanceInputItem);
      });
