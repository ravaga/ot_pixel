...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KpiOperationStatic', function() {
      beforeEach(function() {
        instance = new Otpixel.KpiOperationStatic();
      });

      it('should create an instance of KpiOperationStatic', function() {
        // TODO: update the code to test KpiOperationStatic
