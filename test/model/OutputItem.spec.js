...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OutputItem', function() {
      beforeEach(function() {
        instance = new Otpixel.OutputItem();
      });

      it('should create an instance of OutputItem', function() {
        // TODO: update the code to test OutputItem
        expect(instance).to.be.a(Otpixel.OutputItem);
      });
