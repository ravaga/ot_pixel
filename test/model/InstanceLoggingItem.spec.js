...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InstanceLoggingItem', function() {
      beforeEach(function() {
        instance = new Otpixel.InstanceLoggingItem();
      });

      it('should create an instance of InstanceLoggingItem', function() {
        // TODO: update the code to test InstanceLoggingItem
        expect(instance).to.be.a(Otpixel.InstanceLoggingItem);
      });
