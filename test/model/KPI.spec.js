...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KPI', function() {
      ...
      it('should have the property indexRef (base name: "indexRef")', function() {
        // TODO: update the code to test the property indexRef
        expect(instance).to.have.property('indexRef');
        // expect(instance.indexRef).to.be(expectedValueLiteral);
      });
