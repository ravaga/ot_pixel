...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IHConfig', function() {
      beforeEach(function() {
        instance = new Otpixel.IHConfig();
      });

      it('should create an instance of IHConfig', function() {
        // TODO: update the code to test IHConfig
        expect(instance).to.be.a(Otpixel.IHConfig);
      });
