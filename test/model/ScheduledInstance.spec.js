...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScheduledInstance', function() {
      ...
      it('should have the property lastEnd (base name: "lastEnd")', function() {
        // TODO: update the code to test the property lastEnd
        expect(instance).to.have.property('lastEnd');
        // expect(instance.lastEnd).to.be(expectedValueLiteral);
      });
