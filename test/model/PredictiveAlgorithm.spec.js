...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PredictiveAlgorithm', function() {
      beforeEach(function() {
        instance = new Otpixel.PredictiveAlgorithm();
      });

      it('should create an instance of PredictiveAlgorithm', function() {
        // TODO: update the code to test PredictiveAlgorithm
        expect(instance).to.be.a(Otpixel.PredictiveAlgorithm);
      });
      ...
      it('should have the property lastTrained (base name: "lastTrained")', function() {
        // TODO: update the code to test the property lastTrained
        expect(instance).to.have.property('lastTrained');
        // expect(instance.lastTrained).to.be(expectedValueLiteral);
      });
