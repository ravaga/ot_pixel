...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConnectorItem', 'model/ConnectorOptionItem', 'model/DockerInfo', 'model/DockerRepo', 'model/GeneralInfo', 'model/InputItem', 'model/InputOptionItem', 'model/Instance', 'model/InstanceForceInputItem', 'model/InstanceInputItem', 'model/InstanceInputOptionItem', 'model/InstanceLoggingItem', 'model/InstanceLoggingOptionItem', 'model/InstanceOutputItem', 'model/InstanceOutputOptionItem', 'model/JsonNode', 'model/KPI', 'model/KpiThresholds', 'model/LoggingItem', 'model/LoggingOptionItem', 'model/Model', 'model/OutputItem', 'model/OutputOptionItem', 'model/ScheduleInfo', 'model/ScheduledInstance', 'model/SupportedTransformationItem', 'model/SystemInfo', 'model/Transform', 'api/InstanceResourceApi', 'api/KPIResourceApi', 'api/ModelResourceApi', 'api/ScheduledInstanceResourceApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/ConnectorItem'), require('./model/ConnectorOptionItem'), require('./model/DockerInfo'), require('./model/DockerRepo'), require('./model/GeneralInfo'), require('./model/InputItem'), require('./model/InputOptionItem'), require('./model/Instance'), require('./model/InstanceForceInputItem'), require('./model/InstanceInputItem'), require('./model/InstanceInputOptionItem'), require('./model/InstanceLoggingItem'), require('./model/InstanceLoggingOptionItem'), require('./model/InstanceOutputItem'), require('./model/InstanceOutputOptionItem'), require('./model/JsonNode'), require('./model/KPI'), require('./model/KpiThresholds'), require('./model/LoggingItem'), require('./model/LoggingOptionItem'), require('./model/Model'), require('./model/OutputItem'), require('./model/OutputOptionItem'), require('./model/ScheduleInfo'), require('./model/ScheduledInstance'), require('./model/SupportedTransformationItem'), require('./model/SystemInfo'), require('./model/Transform'), require('./api/InstanceResourceApi'), require('./api/KPIResourceApi'), require('./api/ModelResourceApi'), require('./api/ScheduledInstanceResourceApi'));
  }
}(function(ApiClient, ConnectorItem, ConnectorOptionItem, DockerInfo, DockerRepo, GeneralInfo, InputItem, InputOptionItem, Instance, InstanceForceInputItem, InstanceInputItem, InstanceInputOptionItem, InstanceLoggingItem, InstanceLoggingOptionItem, InstanceOutputItem, InstanceOutputOptionItem, JsonNode, KPI, KpiThresholds, LoggingItem, LoggingOptionItem, Model, OutputItem, OutputOptionItem, ScheduleInfo, ScheduledInstance, SupportedTransformationItem, SystemInfo, Transform, InstanceResourceApi, KPIResourceApi, ModelResourceApi, ScheduledInstanceResourceApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The DockerRepo model constructor.
     * @property {module:model/DockerRepo}
     */
