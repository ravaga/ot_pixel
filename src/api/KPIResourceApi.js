...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getKPIStatsByID operation.
     * @callback module:api/KPIResourceApi~getKPIStatsByIDCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.to to
     * @param {module:api/KPIResourceApi~getKPIStatsByIDCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonNode}
     */
    this.getKPIStatsByID = function(id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getKPIStatsByID");
      }
    ...
    /**
     * Callback function to receive the result of the getLastKPIByID operation.
     * @callback module:api/KPIResourceApi~getLastKPIByIDCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JsonNode} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {String} id kpi
     * @param {module:api/KPIResourceApi~getLastKPIByIDCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonNode}
     */
    this.getLastKPIByID = function(id, callback) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getLastKPIByID");
      }
